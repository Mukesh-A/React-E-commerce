  ...
  const handelFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      if (newFilter[section.id]) {
        ...
        // console.log("newFilter[section.id]", section.id, option.value);
      } else {
      ...
      // console.log("index", index, newFilter);
      newFilter[section.id].splice(index, 1); //splice(starting position, deleteCount);
    }
      ...
      <div className="bg-white">
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* section of products and filter end */}
