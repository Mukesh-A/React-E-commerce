...
const Checkout = () => {
  ...
  return (
    <>
      ...
      {/* {currentOrder && currentOrder.paymentMethod == "cash" && setCart(true)} */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
            <div className="lg:col-span-3">
              <form
                className="bg-white px-5 py-5 my-12"
                noValidate
              ...
              >
                <div className="space-y-12">
                  ...
                  <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-xl font-bold leading-3 text-gray-900">
                      Address
                    </h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                      Choose Address
              ...
              <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <div className="mt-6">
                    <div
                      onClick={handleOrder}
                      className="flex cursor-pointer items-center justify-center rounded-md border border-transparent bg-indigo-600 px-3 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                    >
                      Order Now
                    </div>
                  </div>
